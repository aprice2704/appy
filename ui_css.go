...
const cssStyles = `
       ...
       .controls { display: grid; grid-template-columns: 1fr auto 1fr; align-items: center; background: #121826; padding: 12px 18px; border-radius: 6px; border: 1px solid #2d3748; }
       .control-group { display: flex; gap: 8px; align-items: center; }
       .prep-group { justify-content: flex-start; }
       .action-group { justify-content: center; }
       .export-group { justify-content: flex-end; position: relative; }
       
              button { padding: 0 16px; height: 38px; min-width: 100px; justify-content: center;
...
gap: 6px; white-space: nowrap; box-sizing: border-box; }
       ...
       #copyLedgerBtn, #historyBtn { background: #475569; color: white; border: 1px solid #64748b; }
